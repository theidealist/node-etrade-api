...
exports.getAccessToken = function(verificationCode,successCallback,errorCallback)
{
    ...
    if (arguments.length != 3)
        throw "Invalid invocation of etrade::getAccessToken(): Three arguments are required";
    else if (typeof(successCallback) != "function" ||
              typeof(errorCallback) != "function")
        throw "Invalid invocation of etrade::getAccessToken(): One or more callbacks are not function objects";
    else if (verificationCode.length == 0)
        errorCallback("Verification Code cannot be empty");
