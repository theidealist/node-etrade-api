...
exports.prototype._validateParams = function(paramsDescriptor,params)
{
    for (var paramDescriptor in paramsDescriptor)
    {
        ...
        {
            validationResult = paramDescriptor.validator(params[name]);
            ...
            {
                return "Request parameter '" + name + "' failed validation check";
            }
        }
    }
...
exports.prototype._run = function(actionDescriptor,params,successCallback,errorCallback)
{
    ...
    if (actionDescriptor.method == "GET" && false)
    {
    ...
    else if (true || actionDescriptor.method == "POST" || actionDescriptor.method == "DELETE")
    {
        // Add our token
        requestOptions.qs.oauth_token = this.configuration.oauth.access_token;
        ...
        // We need to specify a few headers for the request
        ...
        requestOptions.headers["Authorization"] = "OAuth realm=\"\"," +
    ...
    console.log("Request: [" + requestOptions.method + "]: " + requestOptions.url + "?" + 
                querystring.stringify(requestOptions.qs));
